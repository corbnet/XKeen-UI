  ...
  EditorView.theme(
    {
      '&': {
        ...
        '--cm-fold-placeholder-text': isDarkTheme ? '#7aa2f7' : '#d9772f',
        '--cm-border': isDarkTheme ? '#334155' : '#cbd5e1',
        '--cm-property': isDarkTheme ? '#7aa2f7' : '#d9772f',
...
export const CodeMirrorEditor = forwardRef<CodeMirrorRef, Props>(({ onContentChange, onValidationChange, onReady, onSave }, ref) => {
  ...
  const createExtensions = useCallback(
    (darkTheme: boolean): Extension[] => [
      ...
      indentationMarkers({ thickness: 2, colors: { activeDark: '#57a8d4', activeLight: '#f0883e' } }),
