...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-2 rounded-md py-1.5 pr-8 pl-2.5 text-sm outline-hidden select-none focus:bg-(--menu-active-bg) focus:font-semibold focus:text-[#f0883e] focus:**:text-[#f0883e] data-disabled:pointer-events-none data-disabled:opacity-50 data-highlighted:bg-(--menu-active-bg) data-highlighted:font-semibold data-highlighted:text-[#f0883e] data-highlighted:**:text-[#f0883e] data-inset:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      checked={checked}
      {...props}
...
function DropdownMenuShortcut({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      className={cn(
        'text-muted-foreground ml-auto text-xs tracking-widest group-focus/dropdown-menu-item:font-semibold group-focus/dropdown-menu-item:text-[#f0883e]',
        className
      )}
      {...props}
    />
...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-2 rounded-sm px-1.5 py-1.25 text-sm outline-hidden select-none focus:bg-(--menu-active-bg) focus:font-semibold focus:text-[#f0883e] not-data-[variant=destructive]:focus:**:text-[#f0883e] data-highlighted:bg-(--menu-active-bg) data-highlighted:font-semibold data-highlighted:text-[#f0883e] not-data-[variant=destructive]:data-highlighted:**:text-[#f0883e] data-inset:pl-8 data-open:bg-(--menu-active-bg) data-open:font-semibold data-open:text-[#f0883e] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
